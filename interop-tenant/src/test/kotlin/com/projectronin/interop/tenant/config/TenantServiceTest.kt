...
class TenantServiceTest {
    ...
    private val standardEpicTenantDO =
        mockk<EpicTenantDO> {
    ...
    private val standardEpicTenantDO2 =
        mockk<EpicTenantDO> {
    ...
    private val standardCernerTenantDO =
        mockk<CernerTenantDO> {
    ...
    fun `get with bad database throws error, actually impossible to hit`() {
        ...
        every { mockEHRTenantDAO.getByTenantMnemonic("test") } returns
            mockk {
            }
