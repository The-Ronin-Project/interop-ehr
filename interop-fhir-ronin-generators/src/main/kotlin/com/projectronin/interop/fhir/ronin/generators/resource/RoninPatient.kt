...
fun rcdmPatient(tenant: String, block: PatientGenerator.() -> Unit): Patient {
    return patient {
        ...
        identifier of rcdmMrn(identifier) + rcdmIdentifiers(tenant, identifier)
...
internal fun rcdmMrn(identifiers: ListDataGenerator<Identifier>): List<Identifier> {
    ...
    if (generatedIdentifiers.none { it.system == CodeSystem.RONIN_MRN.uri && it.type == CodeableConcepts.RONIN_MRN }) {
