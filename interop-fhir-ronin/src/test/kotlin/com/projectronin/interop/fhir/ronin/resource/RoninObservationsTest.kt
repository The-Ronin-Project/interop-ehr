...
class RoninObservationsTest {
    ...
    fun `transforms observation with only required attributes - multiple profiles`() {
        ...
        val laboratoryCodeCodingList = listOf(
            Coding(
                code = Code("2708-6"),
        ...
        val conceptMapMetadata = ConceptMapMetadata(
        ...
        val tenantLaboratoryResultConcept = CodeableConcept(
        ...
        val tenantLaboratoryResultSourceExtension = Extension(
        ...
        val mappedTenantLaboratoryResultConcept = CodeableConcept(
        ...
        val laboratoryCodeConcept = CodeableConcept(
            text = "Laboratory Result".asFHIR(),
            coding = listOf(
                Coding(
                    code = Code("2708-6"),
        ...
        val tenantComponentSourceCodeExtension = Extension(
        ...
        val concentrationCoding = listOf(
        ...
        val concentrationSourceExtension = Extension(
        ...
        val flowRateSourceExtension = Extension(
            url = RoninExtension.TENANT_SOURCE_OBSERVATION_COMPONENT_CODE.uri,
            value = DynamicValue(
                DynamicValueType.CODEABLE_CONCEPT,
        ...
        val registryClientLab = mockk<NormalizationRegistryClient> {
            every {
        ...
        val registryClientPulseOx = mockk<NormalizationRegistryClient> {
            every {
        ...
        val registryClientBodyHeight = mockk<NormalizationRegistryClient> {
            every {
                getRequiredValueSet("Observation.code", RoninProfile.OBSERVATION_BODY_HEIGHT.value)
            } returns ValueSetList(
                listOf(
                    Coding(
                        system = CodeSystem.LOINC.uri,
        ...
        val registryClientBodyMassIndex = mockk<NormalizationRegistryClient> {
            every {
        ...
        val registryClientBSA = mockk<NormalizationRegistryClient> {
            every {
        ...
        val registryClientBodyTemp = mockk<NormalizationRegistryClient> {
            every {
        ...
        val registryClientBodyWeight = mockk<NormalizationRegistryClient> {
            every {
        ...
        val registryClientBP = mockk<NormalizationRegistryClient> {
            every {
            ...
            } returns ValueSetList(listOf(Coding(system = CodeSystem.LOINC.uri, code = Code("8480-6"))), valueSetMetadata)
            every {
                getRequiredValueSet("Observation.component:diastolic.code", RoninProfile.OBSERVATION_BLOOD_PRESSURE.value)
            } returns ValueSetList(listOf(Coding(system = CodeSystem.LOINC.uri, code = Code("8462-4"))), valueSetMetadata)
            every {
                getConceptMapping(
                    tenant,
                    "Observation.code",
        ...
        val registryClientRR = mockk<NormalizationRegistryClient> {
            every {
        ...
        val registryClientHR = mockk<NormalizationRegistryClient> {
            every {
        ...
        val registryClientStagingRelated = mockk<NormalizationRegistryClient> {
            every {
        ...
        val roninObservation = RoninObservations(
        ...
        val observation = Observation(
            ...
            code = CodeableConcept(
                ...
                coding = listOf(
                    Coding(
                        code = Code("2708-6"), // this code is in both lab result and pulse ox
                        system = CodeSystem.LOINC.uri,
                        display = "Laboratory Result".asFHIR()
                    )
                )
        ...
        assertEquals(
            Meta(profile = listOf(Canonical(RoninProfile.OBSERVATION_LABORATORY_RESULT.value), Canonical(RoninProfile.OBSERVATION_PULSE_OXIMETRY.value)), source = Uri("source")),
            transformed.meta
        )
