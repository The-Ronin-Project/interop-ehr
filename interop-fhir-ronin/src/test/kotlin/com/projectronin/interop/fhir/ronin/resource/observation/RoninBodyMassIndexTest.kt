...
class RoninBodyMassIndexTest {
    ...
    private val testNormalizer =
        mockk<Normalizer> {
            every { normalize(any(), tenant) } answers { firstArg() }
        }
    private val testLocalizer =
        mockk<Localizer> {
    ...
    private val tenantBodyMassIndexCoding =
        Coding(
            system = CodeSystem.LOINC.uri,
            display = "Tenant Body Mass Index".asFHIR(),
            code = Code("bad-body-mass-index"),
        )
    private val tenantBodyMassIndexConcept =
        CodeableConcept(
            text = "Tenant Body Mass Index".asFHIR(),
            coding = listOf(tenantBodyMassIndexCoding),
        )
    private val mappedTenantBodyMassIndexConcept =
        CodeableConcept(
            text = "Body Mass Index".asFHIR(),
            coding = bodyMassIndexCodingList,
        )
    private val tenantBodyMassIndexSourceExtension =
        Extension(
    ...
    private val tenantComponentSourceCodeExtension =
        Extension(
    ...
    private val vitalSignsCategoryCoding =
        Coding(
    ...
    private val normRegistryClient =
