...
class RoninProcedureTest {
    ...
    private fun procedureExtensionCode() = Extension(
    ...
    private fun procedureExtensionCategory() = Extension(
    ...
    @BeforeEach
    fun setup() {
        registryClient = mockk<NormalizationRegistryClient> {
            every {
                getConceptMapping(
                    tenant,
                    "Procedure.code",
            ...
            } returns ConceptMapCodeableConcept(CodeableConcept(), procedureExtensionCode(), listOf(conceptMapMetadata))
            every {
                getConceptMapping(
                    tenant,
                    "Procedure.category",
            ...
            } returns ConceptMapCodeableConcept(CodeableConcept(), procedureExtensionCategory(), listOf(conceptMapMetadata))
            every {
                getConceptMapping(
                    tenant,
                    "Procedure.code",
    ...
    fun `validate fails with more than one extension category`() {
        val procedure = Procedure(
            ...
            extension = listOf(procedureExtensionCode(), procedureExtensionCategory(), procedureExtensionCategory()),
            status = EventStatus.ON_HOLD.asCode(),
            subject = Reference(reference = FHIRString("Patient/123123")),
            code = CodeableConcept()
        )
