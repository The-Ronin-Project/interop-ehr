...
class RoninPulseOximetryTest {
    ...
    private val tenantPulseOximetryCoding =
        Coding(
            system = CodeSystem.LOINC.uri,
            display = "Pulse Oximetry".asFHIR(),
            code = Code("bad-body-height"),
        )
    private val tenantPulseOximetryConcept =
        CodeableConcept(
            text = "Tenant Pulse Oximetry".asFHIR(),
            coding = listOf(tenantPulseOximetryCoding),
        )
    private val mappedTenantPulseOximetryConcept =
        CodeableConcept(
            text = "Pulse Oximetry".asFHIR(),
            coding = pulseOximetryCodingList,
        )
    private val tenantPulseOximetrySourceExtension =
        Extension(
    ...
    private val flowRateSourceExtension =
        Extension(
    ...
    private val concentrationSourceExtension =
        Extension(
            url = RoninExtension.TENANT_SOURCE_OBSERVATION_COMPONENT_CODE.uri,
            value =
                DynamicValue(
