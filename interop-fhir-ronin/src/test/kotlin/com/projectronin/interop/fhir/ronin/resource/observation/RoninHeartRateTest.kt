...
class RoninHeartRateTest {
    ...
    private val tenantHeartRateCoding =
        Coding(
            system = CodeSystem.LOINC.uri,
            display = "Heart Rate".asFHIR(),
            code = Code("bad-body-height"),
        )
    private val tenantHeartRateConcept =
        CodeableConcept(
            text = "Tenant Heart Rate".asFHIR(),
            coding = listOf(tenantHeartRateCoding),
        )
    private val mappedTenantHeartRateConcept =
        CodeableConcept(
            text = "Heart Rate".asFHIR(),
            coding = heartRateCodingList,
        )
    private val tenantHeartRateSourceExtension =
        Extension(
