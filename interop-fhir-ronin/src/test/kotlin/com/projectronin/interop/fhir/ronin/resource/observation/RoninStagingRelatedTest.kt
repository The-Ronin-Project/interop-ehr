...
class RoninStagingRelatedTest {
    ...
    private val stagingRelatedCoding =
        Coding(
    ...
    private val tenantStagingRelatedSourceExtension =
        Extension(
    ...
    private val componentCodeExtension =
        Extension(
    ...
    private val componentCode2Extension =
        Extension(
            url = RoninExtension.TENANT_SOURCE_OBSERVATION_COMPONENT_CODE.uri,
            value =
                DynamicValue(
    ...
    private val tenantStagingRelatedCompValueExtension =
        Extension(
