...
class RoninBodyWeightTest {
    ...
    private val tenantBodyWeightCoding =
        Coding(
            system = CodeSystem.LOINC.uri,
            display = "Bad Body Weight".asFHIR(),
            code = Code("bad-body-weight"),
        )
    private val tenantBodyWeightConcept =
        CodeableConcept(
            text = "Tenant Body Weight".asFHIR(),
            coding = listOf(tenantBodyWeightCoding),
        )
    private val mappedTenantBodyWeightConcept =
        CodeableConcept(
            text = "Body Weight".asFHIR(),
            coding = bodyWeightCodingList,
        )
    private val tenantBodyWeightSourceExtension =
        Extension(
