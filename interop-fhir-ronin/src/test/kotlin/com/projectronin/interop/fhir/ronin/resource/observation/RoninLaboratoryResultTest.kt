...
class RoninLaboratoryResultTest {
    ...
    private val laboratoryCategoryCoding =
        Coding(
    ...
    private val laboratoryCodeCoding =
        Coding(
            code = Code("some-code"),
    ...
    private val tenantLaboratoryResultCoding =
        Coding(
            system = CodeSystem.LOINC.uri,
            display = "Laboratory Result".asFHIR(),
            code = Code("bad-lab-code"),
        )
    private val tenantLaboratoryResultConcept =
        CodeableConcept(
            text = "Tenant Laboratory Result".asFHIR(),
            coding = listOf(tenantLaboratoryResultCoding),
        )
    private val mappedTenantLaboratoryResultConcept =
        CodeableConcept(
            text = "Laboratory Result".asFHIR(),
            coding = laboratoryCodeCodingList,
        )
    private val tenantLaboratoryResultSourceExtension =
        Extension(
    ...
    fun `validate checks R4 profile`() {
        ...
        every { R4ObservationValidator.validate(observation, LocationContext(Observation::class)) } returns
            validation {
                checkNotNull(
                    null,
