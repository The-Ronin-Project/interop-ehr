...
class RoninDocumentReferenceTest {
    ...
    private val categoryCodingList =
        listOf(
            Coding(
    ...
    private val tenantDocRefTypeCoding =
        Coding(
            system = CodeSystem.LOINC.uri,
    ...
    private val tenantDocRefTypeConcept =
        CodeableConcept(
            coding = tenantDocRefTypeCodingList,
            text = "Tenant action plan concept".asFHIR(),
        )
    private val tenantDocRefTypeExtension =
        Extension(
    ...
    private val docRefTypeMetadata =
        ConceptMapMetadata(
    ...
    @Test
    fun `validate - passes if encounter contains one reference`() {
        val documentReference =
            DocumentReference(
                meta = Meta(profile = listOf(Canonical(RoninProfile.DOCUMENT_REFERENCE.value)), source = Uri("source")),
                extension = documentReferenceExtension,
        ...
        assertNotNull(roninDocumentReference.validate(documentReference).alertIfErrors())
    }
                                                    ...
                                                    Extension(
                                                        ...
                                                        value =
                                                            DynamicValue(
                                                                ...
                                                                FHIRString("datalakeLocation/1234"),
                                                            ),
                                                    ),
                                                ),
                                        ),
