...
class RoninContactPointTest {
    ...
    fun `validateUSCore fails for missing system`() {
        ...
        val exception =
            assertThrows<IllegalArgumentException> {
                roninContactPoint.validateUSCore(telecom, LocationContext(CareTeam::class), Validation())
                    .alertIfErrors()
            }
    ...
    fun `validate fails for telecom system with wrong URL in source extension`() {
        ...
        val exception =
            assertThrows<IllegalArgumentException> {
                roninContactPoint.validateRonin(telecom, LocationContext(Organization::class), Validation())
                    .alertIfErrors()
            }
                                                ...
                                                value =
                                                    Coding(
                                                        system =
                                                            Uri(
                                                                value =
                                                                    RoninConceptMap.CODE_SYSTEMS.toUriString(
                                                                        tenant,
                                                                        "ContactPoint.system",
                                                                    ),
                                                            ),
    ...
    private fun systemCoding(value: String) =
        Coding(
            system = Uri("http://projectronin.io/fhir/CodeSystem/test/ContactPointSystem"),
            code = Code(value = value),
        )

    private fun systemExtension(value: String) =
        Extension(
    ...
    private fun useCoding(value: String) =
        Coding(
            system = Uri("http://projectronin.io/fhir/CodeSystem/test/ContactPointUse"),
            code = Code(value = value),
        )

    private fun useExtension(value: String) =
        Extension(
