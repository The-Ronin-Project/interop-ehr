...
object RoninRespiratoryRate : BaseRoninVitalSign(R4ObservationValidator, RoninProfile.OBSERVATION_RESPIRATORY_RATE.value) {
    ...
    override fun qualifies(resource: Observation): Boolean {
        return resource.code?.coding?.any { it.system == CodeSystem.LOINC.uri && it.code == respiratoryRateCode } ?: false
    }
